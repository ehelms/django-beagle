...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field references on 'CombinedArticle'
        db.create_table('djbeagle_combinedarticle_references', (
        ...
        db.create_unique('djbeagle_combinedarticle_references', ['combinedarticle_id', 'article_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field references on 'CombinedArticle'
        db.delete_table('djbeagle_combinedarticle_references')
    ...
    models = {
        ...
        'djbeagle.search': {
            ...
            'combined': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['djbeagle.CombinedSearch']", 'unique': 'True', 'null': 'True'}),
