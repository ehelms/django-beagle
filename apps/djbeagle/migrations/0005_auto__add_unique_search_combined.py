...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Search', fields ['combined']
        db.create_unique('djbeagle_search', ['combined_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Search', fields ['combined']
        db.delete_unique('djbeagle_search', ['combined_id'])
