...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field criteria on 'Article'
        db.create_table('djbeagle_article_criteria', (
        ...
        db.create_unique('djbeagle_article_criteria', ['article_id', 'criterion_id'])

        # Adding field 'CombinedArticle.title'
        db.add_column('djbeagle_combinedarticle', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field criteria on 'Article'
        db.delete_table('djbeagle_article_criteria')

        # Deleting field 'CombinedArticle.title'
        db.delete_column('djbeagle_combinedarticle', 'title')
