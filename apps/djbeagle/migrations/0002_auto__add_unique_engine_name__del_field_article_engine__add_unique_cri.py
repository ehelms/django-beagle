...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('djbeagle_engine', ['name'])

        # Deleting field 'Article.engine'
        db.delete_column('djbeagle_article', 'engine')
        ...
        # Adding unique constraint on 'Criterion', fields ['search_string']
        db.create_unique('djbeagle_criterion', ['search_string'])


    def backwards(self, orm):
        # Removing unique constraint on 'Criterion', fields ['search_string']
        db.delete_unique('djbeagle_criterion', ['search_string'])

        # Removing unique constraint on 'Engine', fields ['name']
        db.delete_unique('djbeagle_engine', ['name'])
